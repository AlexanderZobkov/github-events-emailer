...
. Create a copy of link:src/main/resources/application.properties[application.properties] with adjusted settings.

. Place the file where Spring Boot link:https://docs.spring.io/spring-boot/docs/current/reference/html/spring-boot-features.html#boot-features-external-config-application-property-files[can find it].
